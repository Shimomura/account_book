...
class WalletHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet_history" do
    assert_difference('WalletHistory.count') do
      post wallet_histories_url, params: { wallet_history: { amount: @wallet_history.amount, name: @wallet_history.name } }
    end
  ...
  test "should update wallet_history" do
    patch wallet_history_url(@wallet_history), params: { wallet_history: { amount: @wallet_history.amount, name: @wallet_history.name } }
